...
> Historical template. No GitHub Project is configured or implied by this document.
...
Do not duplicate ownership, dates, or version information in multiple fields.
...
2. **Security** — items whose Security field is Pending or Blocked.
