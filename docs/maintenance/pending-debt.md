...
- 2026-08-27 — Configure and verify the GitHub remote for this checkout, branch
  protection with the `required` quality aggregator and independent
  documentation/security checks, tag protection for `plugin/**/v*`, the
...
- 2026-08-27 — Publish the next marketplace product from the reusable document
  and spreadsheet template Skills. Prioritize the following for Forestal MT
  workflows:
  - `Sales Pipeline`
  - `Operating Review`
  - `Project Tracker`
