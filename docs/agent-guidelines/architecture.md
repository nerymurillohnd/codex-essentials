...
- `templates/` contains marketplace and plugin JSON Schemas plus product-documentation templates. `scripts/` contains validators, generators, documentation gates, release checks, and Project bootstrap helpers. `types/` contains TypeScript contracts. `tests/` contains Vitest tests.
...
the PR that changes behavior must update the affected documentation.
