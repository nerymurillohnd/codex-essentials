...
- The [release publication decision](docs/decisions/adr-0010-release-publication-without-environment.md)
  records the current release boundary and approval model.
