...
All notable changes to Configure Prettier are documented in this file.
...
- Initial marketplace package with skills: Audit and propose approval-gated Prettier changes.
