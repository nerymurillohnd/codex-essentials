...
[![Version: 0.1.0](https://img.shields.io/badge/version-0.1.0-blue.svg)](https://github.com/nerymurillohnd/codex-essentials/releases/tag/plugin/doc-keeper/v0.1.0)
...
| ------- | --------------------------------------------------------------------------------------------------------- | -------------------------- |
| `0.1.0` | [Release 0.1.0](https://github.com/nerymurillohnd/codex-essentials/releases/tag/plugin/doc-keeper/v0.1.0) | `plugin/doc-keeper/v0.1.0` |
