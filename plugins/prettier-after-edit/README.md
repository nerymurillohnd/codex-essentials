...
[![Version: 0.1.1](https://img.shields.io/badge/version-0.1.1-blue.svg)](https://github.com/nerymurillohnd/codex-essentials/releases/tag/plugin/prettier-after-edit/v0.1.1)
...
| ------- | ------------------------------------------------------------------------------------------------------------------ | ----------------------------------- |
| `0.1.1` | [Release 0.1.1](https://github.com/nerymurillohnd/codex-essentials/releases/tag/plugin/prettier-after-edit/v0.1.1) | `plugin/prettier-after-edit/v0.1.1` |
